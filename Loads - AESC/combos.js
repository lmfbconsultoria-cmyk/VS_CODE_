...
function setLoadingState(isLoading) {
    const button = document.getElementById(`run-combo-calculation-btn`);
    if (!button) return;
...
function renderComboResults(fullResults) {
    ...
    html += `<div class="border rounded-md p-4 bg-gray-50 dark:bg-gray-800/50 mt-8">
            <h3 class="text-xl font-semibold text-center mb-4">Overall Governing Loads (${fullResults.inputs.design_method})</h3>
...
function handleSaveComboInputs() {
